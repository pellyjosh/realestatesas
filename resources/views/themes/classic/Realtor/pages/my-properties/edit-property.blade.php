                    ...
                    <div class="card-body admin-form">
                        <form class="row gx-3">
                            ...
                            <div class="form-group col-sm-4">
                                ...
                                <div class="dropdown">
                                    <span class="dropdown-toggle font-rubik" data-bs-toggle="dropdown"><span>For Rent</span>
                            ...
                            <div class="form-group col-sm-4">
                                ...
                                <div class="dropdown">
                                    <span class="dropdown-toggle font-rubik" data-bs-toggle="dropdown"><span>3</span> <i
                            ...
                            <div class="form-group col-sm-4">
                                <label>Beds</label>
                                <div class="dropdown">
                                    <span class="dropdown-toggle font-rubik" data-bs-toggle="dropdown"><span>2</span> <i
                                            class="fas fa-angle-down"></i></span>
                                    <div class="dropdown-menu text-start">
                                        <a class="dropdown-item" href="javascript:void(0)">1</a>
                                        <a class="dropdown-item" href="javascript:void(0)">2</a>
