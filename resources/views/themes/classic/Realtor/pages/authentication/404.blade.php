               ...
               <div class="row">
                    ...
                    <div class="col-lg-6 col-md-8 col-sm-10">
                        <div class="not-found-content">
                            ...
                            <p class="font-roboto light-font">We are sorry but the page you are looking for doesn't exist or has been removed. please check or search again.</p>
                            <div class="btns">
                                <a href="{{ route('admin.dashboard') }}" class="btn btn-pill" style="background-color: #78c705; color: #fff; border: none;">go to home page</a>
