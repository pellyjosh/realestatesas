...
<script id="home-sections-json" type="application/json">
    {
        "featured": {
            !!json_encode($featuredSection ? $featuredSection - > toArray() : null) !!
        },
        "properties": {
            !!json_encode($latestSection ? $latestSection - > toArray() : null) !!
        }
    }
</script>
                ...
                <div class="row ratio_55 property-grid-2 property-map map-with-back">
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="alert alert-info mb-3">
                            ...
                            <p x-text="'Properties count: ' + properties.length"></p>
                            <p x-text="'Properties data: ' + JSON.stringify(properties.slice(0, 1))"></p>
                            <p x-text="'First property images: ' + JSON.stringify(getPropertyImages(properties[0] || {}))"></p>
                            <p x-text="'Sample URL: ' + (properties[0] && getPropertyImages(properties[0]).length > 0 ? getImageUrl(getPropertyImages(properties[0])[0]) : 'No images')"></p>
                        </div>
                                ...
                                <div class="col-xl-4 col-md-6 xl-6">
                                    <div class="property-box">
                                        <div class="property-image">
                                            <div class="property-slider" style="position: relative; height: 250px; overflow: hidden;">
                                                {{-- Display property images from database --}}
                                                <template x-if="property.images && property.images.length > 0">
                                                    <div style="position: relative; width: 100%; height: 250px; background: #f8f9fa; display: flex; align-items: center; justify-content: center;">
                                                        ...
                                                        <div style="display: none; color: #6c757d; text-align: center; font-size: 14px;">
                                                            Image failed to load<br>
                                                            <small x-text="'/storage/tenantclient1/' + property.images[0]"></small>
                                                        </div>
                                                    </div>
                                                </template>
                                                {{-- Fallback if no images --}}
                                                <template x-if="!property.images || property.images.length === 0">
                                                    <div style="position: relative; width: 100%; height: 250px; background: #f8f9fa; display: flex; align-items: center; justify-content: center; color: #6c757d; font-size: 14px; text-align: center;">
                                                        <div>
                                                            <div>No Images Available</div>
                                                            <small>Property ID: <span x-text="property.id"></span></small>
                                                        </div>
                                                    </div>
                                                </template>
                                            </div>
                                            ...
                                            <div style="position:absolute;bottom:0;right:0;margin:8px;z-index:10;"
                                                ...
                                                <div x-show="open" @@click.outside="open = false" x-transition
                                                    class="shadow rounded py-2 px-3 bg-white"
            ...
            <div class="modal-body">
                <form class="row gx-3" @@submit.prevent="submitProperty">
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <input type="text" class="form-control" x-model="form.latitude"
                            placeholder="Latitude">
                    </div>
                    <div class="form-group col-sm-4">
                        <label>Longitude</label>
                        <input type="text" class="form-control" x-model="form.longitude"
