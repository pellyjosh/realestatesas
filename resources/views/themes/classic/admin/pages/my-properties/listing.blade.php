                                    ...
                                    <div class="col-xl-4 col-md-6 xl-6">
                                        <div class="property-box">
                                            <div class="property-image">
                                                <div class="property-slider">
                                                    ...
                                                    <div class="slider-nav">
                                                        <button class="prev-arrow"><i
                                                                class="fas fa-arrow-left"></i></button>
                                                        <button class="next-arrow"><i
                                                ...
                                                <div class="overlay-property-box">
                                                    <a href="https://themes.pixelstrap.com/sheltos/main/compare.html"
                                                        class="effect-round" data-bs-toggle="tooltip"
                                                        data-bs-placement="left" title="Compare">
                                                        <i data-feather="shuffle"></i>
                                                    </a>
                                                    <a href="favourites.html" class="effect-round like"
                                            ...
                                            <div class="property-details">
                                                ...
                                                <h6>$6558.00*</h6>
                                                <p class="font-roboto light-font">Real estate is divided into several
                                                    categories, including residential property, commercial property and
                                                ...
                                                <div class="property-btn d-flex">
                                                    ...
                                                    <button type="button"
                                                        class="btn btn-dashed btn-pill color-1">Edit</button>
                                                    <button type="button"
                                                        class="btn btn-dashed btn-pill color-3">Delete</button>
                                                    <button type="button"
                                    ...
                                    <div class="col-xl-4 col-md-6 xl-6">
                                        <div class="property-box">
                                            ...
                                            <div class="property-details">
                                                ...
                                                <h6>$6558.00*</h6>
                                                <p class="font-roboto light-font">This home provides wonderful entertaining
                                                    spaces with a chef
                                    ...
                                    <div class="col-xl-4 col-md-6 xl-6">
                                        <div class="property-box">
                                            ...
                                            <div class="property-details">
                                                ...
                                                <h6>$6558.00*</h6>
                                                <p class="font-roboto light-font">Elegant retreat in a quiet Coral Gables
                                                    setting. This home provides wonderful entertaining spaces with a chef
                                                    kitchen opening…</p>
                                                <ul>
                                                    <li><img src="https://themes.pixelstrap.com/sheltos/assets/images/svg/icon/double-bed.svg"
                                                            class="img-fluid" alt="">Bed : 4</li>
                                    ...
                                    <div class="col-xl-4 col-md-6 xl-6">
                                        <div class="property-box">
                                            ...
                                            <div class="property-details">
                                                ...
                                                <h6>$6558.00*</h6>
                                                <p class="font-roboto light-font">The most common and most absolute type of
                                                    estate, the tenant enjoys the greatest discretion over the disposal of
                                                    the property.</p>
                                                <ul>
                                                    <li><img src="https://themes.pixelstrap.com/sheltos/assets/images/svg/icon/double-bed.svg"
                                                            class="img-fluid" alt="">Bed : 4</li>
                                    ...
                                    <div class="col-xl-4 col-md-6 xl-6">
                                        <div class="property-box">
                                            ...
                                            <div class="property-details">
                                                ...
                                                <h6>$6558.00*</h6>
                                                <p class="font-roboto light-font">Real estate market in most countries are
                                                    not as organize or efficient as markets for other, more liquid
                                    ...
                                    <div class="col-xl-4 col-md-6 xl-6">
                                        <div class="property-box">
                                            ...
                                            <div class="property-details">
                                                ...
                                                <h6>$6558.00*</h6>
                                                <p class="font-roboto light-font">An interior designer is someone who
                                                    plans,researches, management and manages such enhancement projects.</p>
                                                <ul>
                                                    <li><img src="https://themes.pixelstrap.com/sheltos/assets/images/svg/icon/double-bed.svg"
                                                            class="img-fluid" alt="">Bed : 4</li>
                                                    <li><img src="https://themes.pixelstrap.com/sheltos/assets/images/svg/icon/bathroom.svg"
