    ...
    <div class="row report-summary">
                        ...
                        <table class="table table-bordernone m-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="media">
                                            <img src="{{ asset("client/assets/images/property/6.jpg") }}" class="img-fluid img-80" alt="">
                                            <div class="media-body">
                                                <h6>Sea Breezes</h6>
        ...
        {{-- <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="jvector-map-report" id="asia" style="width: 100%; height: 400px;"></div>
                </div>
            </div>
        </div> --}}
        <div class="col-sm-12">
                        ...
                        <table class="table table-bordernone m-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="media">
                                            <img src="{{ asset("client/assets/images/property/22.jpg") }}" class="img-fluid img-80" alt="">
                                            <div class="media-body">
                                                <h6>Sea Breezes</h6>
                                                <span class="light-font">France</span>
                                            </div>
