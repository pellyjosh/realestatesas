                ...
                <div class="toast" :class="toast.type" x-show="true" x-transition>
                    <div class="toast-header">
                        ...
                        <button type="button" class="toast-close"
                            @click="toasts = toasts.filter(t => t.id !== toast.id)">&times;</button>
                    </div>
                        ...
                        <div class="card-body admin-form">
                            <form @submit.prevent="submitForm" class="row gx-3" enctype="multipart/form-data">
                                ...
                                <div class="form-group col-md-4 col-sm-6" x-show="form.title === 'Other'">
                                    ...
                                    <input type="text" class="form-control" placeholder="Specify other title"
                                ...
                                <div class="form-group col-md-4 col-sm-6" x-show="form.marital_status === 'Other'">
                                    ...
                                    <input type="text" class="form-control" placeholder="Specify other marital status"
                                ...
                                <div class="form-group col-md-4 col-sm-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter state of origin"
                                ...
                                <div class="form-group col-md-4 col-sm-6">
                                    <label>LGA</label>
                                    <input type="text" class="form-control" placeholder="Enter local government area"
                                        x-model="form.lga">
                                ...
                                <div class="form-group col-md-4 col-sm-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter hometown"
                                ...
                                <div class="form-group col-sm-12">
                                    ...
                                    <textarea class="form-control" rows="4" placeholder="Enter description" x-model="form.description"></textarea>
                                ...
                                <div class="form-btn col-12">
                                    <button type="submit" class="btn btn-pill btn-gradient color-4"
                                        :disabled="isSubmitting">
                                        <span x-show="isSubmitting">Creating...</span>
                                        <span x-show="!isSubmitting">Create Realtor</span>
                                    </button>
                                    <button type="button" class="btn btn-pill btn-dashed color-4" @click="resetForm">
                                        Cancel
                                    </button>
                                </div>
                            </form>
                    ...
                    async submitForm() {
                        ...
                        try {
                            ...
                            if (response.ok && result.success) {
                                this.showToast('Realtor created successfully!', 'success');
                                this.resetForm();
                                if (result.redirect) {
                                    setTimeout(() => {
                                ...
                                if (result.errors) {
                                    ...
                                    this.showToast(result.message || 'An error occurred while creating the realtor.',
                                        'error');
                                }
                            }
                        } catch (error) {
