                    ...
                    <table class="table">
                        ...
                        <tbody id="table-compare">
                            ...
                            <tr>
                                ...
                                <td class="item-row">
                                    <p class="description-compare">The most common and most absolute type of estate, the
                                        tenant enjoys the greatest discretion over the disposal of the property.</p>
                                </td>
                                <td class="item-row">
                                    <p class="description-compare">Elegant retreat in a quiet Coral Gables setting. This
                                        home provides wonderful entertaining spaces with a chef
                                        kitchen opening…</p>
                                </td>
                                <td class="item-row">
                                    <p class="description-compare">An interior designer is someone who plans,
                                        researches,coordinates, management and manages such enhancement projects.</p>
                                </td>
                                <td class="item-row">
                                    <p class="description-compare">Real estate is divided into several categories, including
                            ...
                            <tr>
                                ...
                                <td class="available-stock">
                                    <button onclick="document.location='user-favourites.html'"
                                        class="add-to-wish btn btn-gradient color-2 btn-block btn-pill">Add to
                                        wishlist</button>
                                </td>
                                <td class="available-stock">
                                    <button onclick="document.location='user-favourites.html'"
                                        class="add-to-wish btn theme color-2 btn-block btn-pill">Add to wishlist</button>
                                </td>
                                <td class="available-stock">
                                    <button onclick="document.location='user-favourites.html'"
                                        class="add-to-wish btn btn-gradient color-2 btn-block btn-pill">Add to
