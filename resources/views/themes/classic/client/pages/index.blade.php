...
@section('main')
                                        ...
                                        <div class="home-slider-1 arrow-light slick-shadow">
                                            <div>
                                                <div class="home-content">
                                                    <div>
                                                        <img src="{{ asset('themes/classic/client/assets/images/signature/2.png') }}"
                                                            class="img-fluid m-0" alt="">
                                                        <h6>Verified Lands & Properties</h6>
                                                        <h1>Your Gateway to Secure Real Estate</h1>
                                                        <a href="#latest-properties"
                                                            class="btn btn-gradient color-6">Explore
                                                            Listings</a>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu text-start">
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="javascript:void(0)">Condominium</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu text-start">
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="javascript:void(0)">Premiere</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <!-- latest for sale section start -->
    @php
        $latest = $sections['latest_properties'] ?? ($sections['latest'] ?? ($sections['latest-properties'] ?? null));
    @endphp
    @if ($latest && ($latest->is_enabled ?? false))
            ...
            <div class="container">
                <div class="row ratio_landscape">
                    <div class="col">
                                        ...
                                        <div class="property-image">
                                            <a href="javascript:void(0)">
                                                ...
                                                <div class="labels-left">
                                                    <span
                                                        class="label label-shadow">{{ $property->status ?? 'Sale' }}</span>
                                                </div>
                                            </a>
                        ...
                        </div> <!-- .listing-hover-property -->
                    </div> <!-- .col -->
                </div> <!-- .row -->
            </div> <!-- .container -->
        </section>
    @endif
    <!-- latest for sale section end -->

    <!-- feature section start -->
    @php
        $featured = $sections['featured'] ?? ($sections['feature'] ?? null);
    @endphp
    @if ($featured && ($featured->is_enabled ?? false))
                                        ...
                                        <div class="col-xl-4 col-lg-3">
                                            <div class="feature-left">
                                                <div class="property-details">
                                                    ...
                                                    <p class="font-roboto">Strategically located in a serene environment,
                                                        this
                                                        land offers a peaceful setting just 10 minutes from the city center.
                                                        It’s fully fenced, gated, and comes with access to electricity and
                                                        water
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-8 col-lg-9 order-md">
                                            <div class="feature-image">
                                                ...
                                                <span class="box-color"></span>
                                                <span class="signature">
                                                    <img src="{{ asset('themes/classic/client/assets/images/signature/1.png') }}"
                                                        alt="">
                                                </span>
                                                <span class="label label-white label-lg color-6">Featured</span>
                                            </div>
                            ...
                            <div class="offer-wrapper">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p>We help you find the perfect property land, residential, or commercial securely
                                            and stress free. Let’s make your next move simple and rewarding.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="offer-wrapper">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p>We verify all properties before listing. Each one comes with proper documentation
                                            such as survey plans, deeds, and government approvals. </p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    @php
        $citiesSection = $sections['cities'] ?? ($sections['city'] ?? null);
    @endphp
    @if ($citiesSection && ($citiesSection->is_enabled ?? false))
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="light-bg banner-1">
                        ...
                        <h6>Premium Refined Luxury Homes</h6>
                        <h2>We don’t just sell land we curate legacy worthy properties that stand the test of time for
                            generations to come.</h2>
    ...
    @php
        $realtorSection = $sections['realtor'] ?? ($sections['realtors'] ?? null);
    @endphp
    @if ($realtorSection && ($realtorSection->is_enabled ?? false))
    ...
    @php
        $testimonialsSection = $sections['testimonials'] ?? ($sections['testimonial'] ?? null);
    @endphp
    @if ($testimonialsSection && ($testimonialsSection->is_enabled ?? false))
                        ...
                        <div class="testimonial-2 arrow-light">
                            ...
                            <div>
                                <div class="client-slider light-bg">
                                    ...
                                    <p>Working with this team was seamless from start to finish. They helped me find the
                                        perfect
