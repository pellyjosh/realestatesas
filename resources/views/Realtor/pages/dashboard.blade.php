                ...
                <div class="large-6 col-lg-12 col-md-6">
                    <div class="card all-properties">
                        <div class="card-body">
                            ...
                            <ul class="light-box">
                                <li>
                                    <img src="{{ asset('admin/assets/images/svg/icon/sold.png') }}" class="img-fluid" alt="">
                                    <div>
                                        <h5>1500</h5>  
                                ...
                                <li>     
                                    <img src="{{ asset('admin/assets/images/svg/icon/rent.png') }}" class="img-fluid" alt="">
                                    <div>                                               
                                        <h5>380</h5>
                                ...
                                <li>      
                                    <img src="{{ asset('admin/assets/images/svg/icon/unlisted.png') }}" class="img-fluid" alt="">
                                    <div>                                                   
                                        <h5>240</h5>
                        ...
                        <table class="table table-bordernone">
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="media">
                                            <img src="{{ asset("admin/assets/images/avatar/1.jpg") }}" class="img-fluid" alt="">
                                            <div class="media-body">
                                ...
                                <tr>
                                    <td>
                                        <div class="media">
                                            <img src="{{ asset ("admin/assets/images/avatar/4.jpg") }}" class="img-fluid" alt="">
                                            <div class="media-body">
        ...
        <div class="col-xl-3 xl-6 col-lg-12 col-md-6">
            <div class="card">
                ...
                <div class="card-body properties-list">
                    <div class="media">
                        <img src="{{ asset("client/assets/images/property/25.jpg") }}" class="img-fluid" alt="">
                        <div class="media-body">
                    ...
                    <div class="media">
                        <img src="{{ asset("client/assets/images/property/7.jpg") }}" class="img-fluid" alt="">
                        <div class="media-body">
                    ...
                    <div class="media">
                        <img src="{{ asset("client/assets/images/property/8.jpg") }}" class="img-fluid" alt="">
                        <div class="media-body">
                        ...
                        <table class="table table-bordernone">
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="media">
                                            <img src="{{ asset('admin/assets/images/svg/icon/pdf.png') }}" class="img-fluid" alt="">
                                            <div class="media-body">
                                ...
                                <tr>
                                    <td>
                                        <div class="media">
                                            <img src="{{ asset('admin/assets/images/svg/icon/microsoft.png') }}" class="img-fluid" alt="">
                                            <div class="media-body">
                                ...
                                <tr>
                                    <td>
                                        <div class="media">
                                            <img src="https://themes.pixelstrap.com/sheltos/assets/images/svg/icon/excel.png" class="img-fluid" alt="">
                                            <div class="media-body">
                                ...
                                <tr>
                                    <td>
                                        <div class="media">
                                            <img src="{{ asset('admin/assets/images/svg/icon/excel.png') }}" class="img-fluid" alt="">
                                            <div class="media-body">
                        ...
                        <div class="d-flex">
                            <div class="media">
                               <div class="with-reload">
                                    <img src="{{ asset('admin/assets/images/svg/icon/1.svg') }}" class="img-fluid" alt="">
                               </div>
                                <div class="media-body">
                                    <h5>78</h5>
