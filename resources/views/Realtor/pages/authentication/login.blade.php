    ...
    <form autocomplete="off">
        ...
        <div class="form-group">
            <div class="input-group">
                ...
                <input type="password" id="pwd-input" class="form-control" placeholder="Password" autocomplete="off" maxlength="8">
        ...
        <div class="d-flex">
            ...
            <a href="https://themes.pixelstrap.com/sheltos/main/forgot-password.html" class="font-rubik text-color-2">Forgot password ?</a>
        </div>
        <div>
