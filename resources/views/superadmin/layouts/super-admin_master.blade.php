...
<body class="theme-purple">
    ...
    <div class="page-loader-wrapper">
        <div class="loader">
            <div class="m-t-30"><img class="zmdi-hc-spin"
                    src="https://wrraptheme.com/templates/oreo/realestate/html/assets/images/logo.svg" width="48"
    ...
    <!-- Top Bar -->
    @include('superadmin.components.top-bar')

    <!-- Left Sidebar -->
    @include('superadmin.components.left-sidebar')
    ...
    <!-- Chat-launcher -->
    @include('superadmin.components.chat-launcher')
    ...
    <script src="{{ asset('superadmin/assets/bundles/c3.bundle.js') }}"></script>
    <script src="{{ asset('superadmin/assets/bundles/jvectormap.bundle.js') }}"></script>
    <script src="{{ asset('superadmin/assets/bundles/knob.bundle.js') }}"></script>


    {{-- Custom Js --}}
    <script src="{{ asset('superadmin/assets/bundles/mainscripts.bundle.js') }}"></script>
    <script src="{{ asset('superadmin/assets/js/pages/index.js') }}"></script>
    <script src="{{ asset('superadmin/assets/js/pages/forms/editors.js') }}"></script>

    {{-- Datatables --}}
    <script src="{{ asset('superadmin/assets/bundles/datatablescripts.bundle.js') }}"></script>
    <script src="{{ asset('superadmin/assets/js/pages/tables/jquery-datatable.js') }}"></script>

    <!--/ calender javascripts -->
    <script src="{{ asset('superadmin/assets/bundles/fullcalendarscripts.bundle.js') }}"></script>
    <script src="{{ asset('superadmin/assets/js/pages/calendar/calendar.js') }}"></script>




    <script src="https://wrraptheme.com/templates/oreo/realestate/html/assets/plugins/ckeditor/ckeditor.js"></script>
</body>
