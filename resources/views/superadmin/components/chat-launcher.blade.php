        ...
        <div class="card">
            <div class="header">
                <ul class="list-unstyled team-info margin-0">
                    ...
                    <li><img src="https://wrraptheme.com/templates/oreo/realestate/html/assets/images/xs/avatar2.jpg"
                            alt="Avatar"></li>
                    <li><img src="https://wrraptheme.com/templates/oreo/realestate/html/assets/images/xs/avatar3.jpg"
                            alt="Avatar"></li>
                    <li><img src="https://wrraptheme.com/templates/oreo/realestate/html/assets/images/xs/avatar4.jpg"
                            alt="Avatar"></li>
                    <li><img src="https://wrraptheme.com/templates/oreo/realestate/html/assets/images/xs/avatar6.jpg"
                            alt="Avatar"></li>
                    <li><a href="javascript:void(0);" title="Add Member"><i class="zmdi zmdi-plus-circle"></i></a>
                    </li>
                </ul>
            </div>
            <div class="body">
