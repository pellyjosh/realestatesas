...
<body>
    ...
    <div class="loader-wrapper">
        <div class="row loader-text">
            <div class="col-12">
                <img src="{{ asset('client/assets/images/loader/loader.gif') }}" class="img-fluid"
                    alt="">
            </div>
            <div class="col-12">
                <div>
                                    ...
                                    <ul class="nav-menu">
                                            ...
                                            <ul class="nav-submenu menu-content">
                                                <li>
                                                    ...
                                                    <ul class="nav-sub-childmenu level1">
                                                        <li>
                                                            <a href="javascript:void(0)" class="submenu-title">2
                                                                Grid</a>
                                                        ...
                                                        <li>
                                                            <a href="javascript:void(0)" class="submenu-title">3
                                                                Grid</a>
                                                            <ul class="nav-sub-childmenu submenu-content level2">
                                                                <li><a href="grid-left-sidebar.html">Left Sidebar</a>
                                                                </li>
                                                                <li><a href="grid-3-right-sidebar.html">Right
                                                                        Sidebar</a>
                                                                </li>
                                                        ...
                                                        <li>
                                                            <a href="javascript:void(0)" class="submenu-title">map
                                                                modal</a>
                                                            <ul class="nav-sub-childmenu submenu-content level2">
                                                        ...
                                                        <li>
                                                            <a href="javascript:void(0)" class="submenu-title">Left
                                                                side map</a>
                                                            <ul class="nav-sub-childmenu submenu-content level2">
                                                        ...
                                                        <li>
                                                            <a href="javascript:void(0)" class="submenu-title">onclick
                                                                map</a>
                                                            <ul class="nav-sub-childmenu submenu-content level2">
                                                                <li><a href="google-clickmap.html">google map</a></li>
                                                                <li><a href="leaflet-clickmap.html">leaflet map</a>
                                                                </li>
                                                ...
                                                <li>
                                                    <a href="javascript:void(0)" class="menu-title-level1">List
                                                        view</a>
                                                    <ul class="nav-sub-childmenu level1">
                                                        <li>
                                                            <a href="javascript:void(0)"
                                                                class="submenu-title">Listing</a>
                                                            <ul class="nav-sub-childmenu submenu-content level2">
                                                        ...
                                                        <li>
                                                            ...
                                                            <ul class="nav-sub-childmenu submenu-content level2">
                                                                ...
                                                                <li><a href="leaflet-list-map.html">leaflet map</a>
                                                                </li>
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul class="nav-submenu menu-content">
                                                ...
                                                <li><a href="single-property-10.html">modal details <span
                                                            class="icon-trend label"><i
                                                                class="fas fa-bolt"></i></span></a></li>
                                            </ul>
                                        </li>
                                        <li class="mega-menu">
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <div class="link-section">
                                                                ...
                                                                <div class="submenu-content opensubmegamenu">
                                                                    <ul class="list">
                                                                        ...
                                                                        <li><a href="portfolio-grid-title-2.html">2
                                                                                grid
                                                                                title</a></li>
                                                                        <li><a href="portfolio-grid-title-3.html">3
                                                                                grid
                                                                                title</a></li>
                                                                        <li><a href="portfolio-grid-title-4.html">4
                                                                                grid
                                                                                title</a></li>
                                                                        ...
                                                                        <li><a href="portfolio-creative-3.html">creative
                                                                                3 <span class="icon-trend label"><i
                                                                                        class="fas fa-bolt"></i></span></a>
                                                                        </li>
                                                                        <li><a href="portfolio-creative-4.html">creative
                                                                                4</a></li>
                                                                        <li><a
                                                                                href="portfolio-details.html">details</a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="submenu-content opensubmegamenu">
                                                                    <ul class="list">
                                                                        ...
                                                                        <li><a href="blog-detail-gallery.html">detail
                                                                                with gallery</a></li>
                                                                        <li><a href="blog-detail-video.html">detail
                                                                                with
                                                                                video</a></li>
                                                                    </ul>
                                                                </div>
                                                        ...
                                                        <div class="col mega-box">
                                                            <div class="link-section">
                                                                ...
                                                                <div class="submenu-content opensubmegamenu">
                                                                    <ul class="list">
                                                                        <li><a href="agency-profile.html">Agency
                                                                                Profile</a></li>
                                                            ...
                                                            <div class="link-section">
                                                                ...
                                                                <div class="submenu-content opensubmegamenu">
                                                                    <ul class="list">
                                                                        <li><a
                                                                                href="https://themes.pixelstrap.com/sheltos/email-template/offer.html">Offer</a>
                                                                        </li>
                                                                        <li><a
                                                                                href="https://themes.pixelstrap.com/sheltos/email-template/confirmation.html">Confirmation</a>
                                                                        </li>
                                                                        <li><a
                                                                                href="https://themes.pixelstrap.com/sheltos/email-template/thankyou.html">Thank
                                                                                you</a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                            <div class="link-section">
                                                                ...
                                                                <div class="submenu-content opensubmegamenu">
                                                                    <ul class="list">
                                                                        <li><a href="user-dashboard.html">user
                                                                                dashboard <span
                                                                                    class="icon-trend label"><i
                                                                                        class="fas fa-bolt"></i></span></a>
                                                                        </li>
                                                                        <li><a href="user-listing.html">My Listing</a>
                                                                        </li>
                                                                        <li><a href="user-create.html">Create
                                                                                property</a></li>
                                                                        <li><a href="user-profile.html">My profile</a>
                                                                        </li>
                                                                        <li><a
                                                                                href="user-favourites.html">Favourites</a>
                                                                        </li>
                                                                        <li><a href="compare.html">Compare Property</a>
                                                                        </li>
                                                                        <li><a href="user-payment.html">Cards &
                                                                                payment</a></li>
                                                                        <li><a href="user-privacy.html">Privacy</a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="link-section">
                                                                ...
                                                                <div class="submenu-content opensubmegamenu">
                                                                    <ul class="list">
                                                                        ...
                                                                        <li><a href="signup-wizard.html">sign up wizard
                                                                                <span class="icon-trend label"><i
                                                                                        class="fas fa-bolt"></i></span></a>
                                                                        </li>
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul class="nav-submenu menu-content">
                                                ...
                                                <li><a href="image-ratio-element.html">Image ratio <span
                                                            class="icon-trend label"><i
                                                                class="fas fa-bolt"></i></span></a>
                                                </li>
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul class="nav-submenu menu-content">
                                                ...
                                                <li><a href="submit-property.html">Submit property <span
                                                            class="label">New</span></a></li>
                                            </ul>
                                        </li>
                                        <li class="dropdown">
