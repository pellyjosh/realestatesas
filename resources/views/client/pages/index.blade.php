                                                    ...
                                                    <div class="col-xl-4 col-lg-3">
                                                        <div class="feature-left">
                                                            <div class="property-details">
                                                                ...
                                                                <p class="font-roboto">We specialize in the acquisition and sale of land across a variety of property types.
                                                                    From individual plots to large, connected parcels, we help our clients navigate every stage of the land investment process. </p>
                                                                {{-- <ul>
                                        ...
                                        <div class="col-xl-4 col-md-6 wow fadeInUp">
                                            <div class="property-box">
                                                ...
                                                <div class="property-details">
                                                    ...
                                                    <p class="font-roboto">From urban plots to rural acreage, we connect buyers and sellers with clear documentation and smooth transactions.</p>
                                                    <ul>
                                                        <li><i class="fas fa-mountain"></i> Land : 3</li>
                                                        <li><i class="fas fa-building"></i> Properties : 2</li>
                                                        <li><img src="{{ asset('client/assets/images/svg/icon/square-ruler-tool.svg') }}"
                                        ...
                                        <div class="col-xl-4 col-md-6 wow fadeInUp">
                                            <div class="property-box">
                                                ...
                                                <div class="property-details">
                                                    ...
                                                    <h6 class="color-6">#6558.00*</h6>
                                                    <p class="font-roboto">Looking to grow your portfolio? We source high-potential properties that deliver long-term value in the long run.</p>
                                                    <ul>
                                                        <li><i class="fas fa-mountain"></i> Land : 3</li>
                                                        <li><i class="fas fa-building"></i> Properties : 2</li>
                                                        <li><img src="{{ asset('client/assets/images/svg/icon/square-ruler-tool.svg') }}"
                                        ...
                                        <div class="col-xl-4 col-md-6 wow fadeInUp">
                                            <div class="property-box">
                                                ...
                                                <div class="property-details">
                                                    ...
                                                    <h6 class="color-6">#4513.00*</h6>
                                                    <p class="font-roboto">We help you find the perfect property—whether it’s land, residential, or commercial—securely and stress-free..</p>
                                                    <ul>
                                                        <li><i class="fas fa-mountain"></i> Land : 3</li>
                                                        <li><i class="fas fa-building"></i> Properties : 2</li>
                                                        <li><img src="{{ asset('client/assets/images/svg/icon/square-ruler-tool.svg') }}"
                                        ...
                                        <div class="col-xl-4 col-md-6 wow fadeInUp">
                                            <div class="property-box">
                                                ...
                                                <div class="property-details">
                                                    ...
                                                    <h6 class="color-6">#4513.00*</h6>
                                                    <p class="font-roboto">Get the best value for your property. Our expert team handles everything from listing to closing 100%.</p>
                                                    <ul>
                                                        <li><i class="fas fa-mountain"></i> Land : 3</li>
                                                        <li><i class="fas fa-building"></i> Properties : 2</li>
                                                        <li><img src="{{ asset('client/assets/images/svg/icon/square-ruler-tool.svg') }}"
                                        ...
                                        <div class="col-xl-4 col-md-6 wow fadeInUp">
                                            <div class="property-box">
                                                ...
                                                <div class="property-details">
                                                    ...
                                                    <h6 class="color-6">#9554.00*</h6>
                                                    <p class="font-roboto">Every property we list is thoroughly verified for title, zoning, and ownership—no surprises, just solid investments.
                                                    </p>
                                                    <ul>
                                                        <li><i class="fas fa-mountain"></i> Land : 3</li>
                                                        <li><i class="fas fa-building"></i> Properties : 2</li>
                                    ...
                                    <div class="about-1 about-wrap arrow-white color-6">
                                            ...
                                            <div class="about-content row">
                                                <div class="col-xl-6">
                                                    <div class="about-image">
                                                        <img src="https://themes.pixelstrap.com/sheltos/assets/images/about/1.jpg" class="img-fluid" alt="">
                                                        <div class="about-overlay"></div>
                                                        <div class="overlay-content">
                                                            <ul>
                                                                <li><a href="https://accounts.google.com/"><img
                                                                            src="https://themes.pixelstrap.com/sheltos/assets/images/about/icon-1.png" alt=""></a>
                                                                </li>
                                                                <li><a href="https://twitter.com/"><img
                                                                            src="https://themes.pixelstrap.com/sheltos/assets/images/about/icon-2.png" alt=""></a>
                                                                </li>
                                                                <li><a href="https://www.facebook.com/"><img
                                                                            src="https://themes.pixelstrap.com/sheltos/assets/images/about/icon-3.png" alt=""></a>
                                                                </li>
                                                            </ul>
                                                            <span>Connect</span>
                                                        </div>
                                        ...
                                        <div>
                                            <div class="about-content row">
                                                <div class="col-xl-6">
                                                    <div class="about-image">
                                                        <img src="https://themes.pixelstrap.com/sheltos/assets/images/about/2.jpg" class="img-fluid" alt="">
                                                        <div class="about-overlay"></div>
                                                        <div class="overlay-content">
                                                            <ul>
                                                                <li><a href="https://accounts.google.com/"><img
