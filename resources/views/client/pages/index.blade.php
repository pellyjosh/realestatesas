                        ...
                        <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                            ...
                            <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                                <div class="property-box">
                                    <div class="property-image">
                                        <a href="javascript:void(0)">
                                            <img src="{{ asset('client/assets/images/3.jpg') }}"
                                                class="bg-img" alt="">
                                            <div class="labels-left">
                    ...
                    <div class="col">
                        ...
                        <div class="testimonial-2 arrow-light">
                            ...
                            <div>
                                <div class="client-slider light-bg">
                                    <ul class="user-list">
                                        <li><img src="https://themes.pixelstrap.com/sheltos/assets/images/testimonial/1.png"
                                                alt=""></li>
                                        <li>
                                            <img src="https://themes.pixelstrap.com/sheltos/assets/images/testimonial/2.png"
                                                alt="">
                                            <div class="heart-bg">
                                            </div>
