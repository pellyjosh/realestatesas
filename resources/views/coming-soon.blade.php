...
<head>
    ...
    <meta name="description" content="Sheltos - Coming soon page 2">
    ...
    <title>Premium Refined Luxury Homes - Coming soon page </title>
        ...
        <div class="container">
            <div class="row log-in">
                <div class="col-lg-6 ratio2_3 order-lg-1">
                    <img src="{{ asset('client/assets/images/svg/soon.svg') }}"
                        class="img-fluid bg-size" style="max-width: 100%" alt="">
                </div>
                <div class="col-lg-6 m-0">
                    ...
                    <div class="site-construction">
                        ...
                        <p class="font-roboto">We're working hard to bring you this new feature. Subscribe below to receive updates as soon as it's available!</p>
                    </div>
                    ...
                    <a href="layout-2.html" class="btn btn-gradient color-2 btn-pill mt-4"> <i
...
<!-- Mirrored from themes.pixelstrap.com/sheltos/main/coming-soon-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Jun 2025 13:52:23 GMT -->
